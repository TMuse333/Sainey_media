...
const Content = ({ title, description, rev, link, linkText, hasTitle, id, hasAnimation, hasTilt }) => {
    ...
    useEffect(() => {
        const handleScroll = () => {
            ...
            // Gradually increase the tilt angle from 0 to -30 as the bottom 30% of the element becomes visible
            const newTiltAngleBottom = Math.min(0, -30 + (visiblePercentBottom / 30) * 30);
