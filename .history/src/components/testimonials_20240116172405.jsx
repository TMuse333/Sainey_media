...
const Testimonials = () => {
  ...
  useEffect(() => {
    ...
    overlayDiv.style.backgroundColor = 'rgba(255, 255, 255, 0.7)'; // Set the background color with some transparency

    // Append the overlay div to the document body
    document.body.appendChild(overlayDiv);

    // Cleanup function to remove the overlay div on component unmount
    return () => {
