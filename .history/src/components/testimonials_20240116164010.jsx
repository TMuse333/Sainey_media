...
const Testimonials = () => {
  ...
  <p className='sample description-text'>
          Lorem ipsum dolor sit, amet consectetur adipisicing elit. Perspiciatis eius saepe in sunt accusantium tempora itaque, corrupti minus voluptate voluptatem?
        </p>
